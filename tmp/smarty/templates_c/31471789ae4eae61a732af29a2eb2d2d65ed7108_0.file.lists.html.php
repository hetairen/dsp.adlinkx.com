<?php
/* Smarty version 3.1.30, created on 2017-03-16 20:27:01
  from "C:\web\www\www.adease.com\application\views\loger\lists.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58ca8495c08632_72990406',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '31471789ae4eae61a732af29a2eb2d2d65ed7108' => 
    array (
      0 => 'C:\\web\\www\\www.adease.com\\application\\views\\loger\\lists.html',
      1 => 1489666539,
      2 => 'file',
    ),
  ),
...
function content_58ca8495c08632_72990406 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
                ...
                <ul class="nav nav-pills nav-stacked nav-bracket">
                    ...
                    <li class="nav-parent  nav-active active"><a href=""><i class="fa fa-file-text"></i> <span>运营管理</span></a>
                        <ul class="children" style="display:block;">
                            <li class="active"><a href="/operationLoger/index"><i class="fa fa-file-text-o" aria-hidden="true"></i>操作日志</a></li>
                        </ul>
                    </li>
...
" alt="" /><?php echo $_smarty_tpl->tpl_vars['user']->value['name'];?>
            ...
            <div class="pageheader">
                <h2><i class="fa fa-file-text-o"></i> Dashboard <span>运营管理</span> <span>操作日志</span></h2>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped" id="table2">
                                ...
                                <tbody>
                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['logers']->value, 'loger');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['loger']->value) {
?>
                                    <!-- <?php echo var_dump($_smarty_tpl->tpl_vars['loger']->value['uid']);?>
 -->
                                    <tr class="gradeA">
                                        <td><?php echo $_smarty_tpl->tpl_vars['loger']->value['uid'];?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['loger']->value['actions'];?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['loger']->value['remarks'];?>
</td>
                                        <td class="center"><?php echo $_smarty_tpl->tpl_vars['loger']->value['ip'];?>
</td>
                                        <td class="center"><?php echo $_smarty_tpl->tpl_vars['loger']->value['timer'];?>
</td>
                                        <td class="center">
                                            <?php if ($_smarty_tpl->tpl_vars['loger']->value['group'] == '' && $_smarty_tpl->tpl_vars['loger']->value['permissions'] == 'rw') {?>
                                            <a href="javascript:void(0);" class="actions-buts" data-uid="<?php echo $_smarty_tpl->tpl_vars['loger']->value['uid'];?>
" data-group="<?php echo $_smarty_tpl->tpl_vars['loger']->value['group'];?>
" data-permissions="<?php echo $_smarty_tpl->tpl_vars['loger']->value['permissions'];?>
" data-type="delete">删除</a> <?php } else { ?>
                                            <a href="javascript:void(0);" class="actions-buts" data-uid="<?php echo $_smarty_tpl->tpl_vars['loger']->value['uid'];?>
" data-group="<?php echo $_smarty_tpl->tpl_vars['loger']->value['group'];?>
" data-permissions="<?php echo $_smarty_tpl->tpl_vars['loger']->value['permissions'];?>
" data-type="read">查看</a> <?php }?>
                                        </td>
                                    </tr>
                                    <?php
}
